...
int main()
{
    ...
    while (type != 0)
    {
        cout << "0 - выход" << endl << "1 - добавить значение" << endl << "2 - удалить значение" << endl << "3 - проверить на прринадлежность" << endl
        << "4 - вывести в возрастающем порядке" << endl << "5 - вывести в убывающем порядке" << endl << "6 - отладочный вывод"
        << endl;
