...
int haveFindMinimumEdge(int numberOfVrteces, bool used[], int minimumEdge[])
{
    int vertex = -1;
    for (int i = 0; i < numberOfVrteces; ++i)
    {
...
int main()
{
    ...
    cout << "При обходе графа получается минимальный отсов веса " << sumOfEdges << endl;
    return 0;
}
